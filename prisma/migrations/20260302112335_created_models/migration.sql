/*
  ...
  - You are about to drop the column `profilephoto` on the `doctor` table. All the data in the column will be lost.
  - You are about to drop the column `contactnumber` on the `patient` table. All the data in the column will be lost.
  - You are about to drop the column `profilephoto` on the `patient` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "doctor" DROP COLUMN "profilephoto",
ADD COLUMN     "profilePhoto" TEXT,
ALTER COLUMN "appointmentFee" DROP DEFAULT;
